...
export default function ToDeliver() {
  ...
  const fetchAll = useCallback(async () => {
    ...
    try {
      ...
      setOpenOrders(orders.filter(o =>
        !scheduledIds.has(String(o.orderId)) &&
      ...
      {!lstLoad && (
        filtered.length === 0
          ...
          : <div className="tdl-sched-grid">
              {filtered.map(d => (
                <div key={d.id}
                  className={`tdl-scard${editId === d.id ? ' tdl-scard--sel' : ''}`}
                  onClick={() => selectScheduled(d)}>
                  ...
                  {/* Quick status — border color only, text stays dark via CSS */}
                  <div className="tdl-scard-foot" onClick={e => e.stopPropagation()}>
                    <select
                      className="tdl-qs"
                      value={d.status || 'SCHEDULED'}
                      style={{ borderColor: sc(d.status) }}
        ...
        <div id="tdl-form" className="card tdl-form-card">
          ...
          <div className="tdl-form-grid">
            <div className="form-group">
              ...
              <input className="form-input" name="orderId" value={form.orderId}
                onChange={handleChange} placeholder="e.g. 1001" readOnly={!!editId}/>
            </div>
            ...
            <div className="form-group">
              ...
              <span className="form-colon">:</span>
              <input className="form-input" name="customerPhone" value={form.customerPhone}
            ...
            <div className="form-group">
              ...
              <span className="form-colon">:</span>
              <input className="form-input" name="deliveryAddress" value={form.deliveryAddress}
            ...
            <div className="form-group">
              ...
              <input className="form-input" name="city" value={form.city}
                onChange={handleChange} placeholder="e.g. Colombo"/>
            </div>
            ...
            <div className="form-group">
              ...
              {drivers.length > 0
                ...
                : <input className="form-input" name="driverId" value={form.driverId}
                    onChange={handleChange} placeholder="e.g. D001"/>
              }
            </div>
            ...
            <div className="form-group tdl-full">
              ...
              <textarea className="form-input" name="notes" value={form.notes}
                onChange={handleChange} placeholder="Special instructions, fragile items…" rows={2}/>
            </div>
          </div>
